Public Class FormCadastroDeVeiculos
    ...
    Private Sub ButtonIncluir_Click(sender As Object, e As EventArgs) Handles ButtonIncluir.Click
        ...
        cm.Parameters.AddWithValue("@modelo", TextBox1Modelo.Text)
        cm.Parameters.AddWithValue("@ano_fabri", MaskedTextBox1Ano.Text)
        cm.Parameters.AddWithValue("@valor_diaria", TextBox2Diaria.Text)
    ...
    Private Sub ButtonLimpar_Click(sender As Object, e As EventArgs) Handles ButtonLimpar.Click
        TextBoxPlaca.Text = ""
        TextBox1Modelo.Text = ""
        MaskedTextBox1Ano.Text = ""
        TextBox2Diaria.Text = ""
        TextBoxStatus.Text = ""
        TextBoxImagem.Text = ""
        PictureBoxCarroImagem.Image = Nothing
            ...
            Try
                ...
                If meuDataReader.HasRows Then
                    While meuDataReader.Read
                        TextBox2Diaria.Text = meuDataReader.Item("valor_diaria")
                        TextBoxImagem.Text = meuDataReader.Item("imagem")
                        TextBox1Modelo.Text = meuDataReader.Item("modelo")
                        TextBoxStatus.Text = meuDataReader.Item("status")
                        MaskedTextBox1Ano.Text = meuDataReader.Item("ano_fabri")
                        PictureBoxCarroImagem.Load(meuDataReader.Item("imagem"))
    ...
    Private Sub LabelImagem_Click(sender As Object, e As EventArgs) Handles LabelImagem.Click

    End Sub

    Private Sub ButtonSelecionarCarro_Click(sender As Object, e As EventArgs) Handles ButtonSelecionarCarro.Click
        If OpenFileDialog.ShowDialog = Windows.Forms.DialogResult.OK Then
            PictureBoxCarroImagem.Load(OpenFileDialog.FileName)
            TextBoxImagem.Text = OpenFileDialog.FileName
        End If
    End Sub

    Private Sub PictureBoxCarroImagem_Click(sender As Object, e As EventArgs) Handles PictureBoxCarroImagem.Click

    End Sub

    Private Sub TextBoxDiaria_TextChanged(sender As Object, e As EventArgs) Handles TextBoxDiaria.TextChanged, TextBox2Diaria.TextChanged
